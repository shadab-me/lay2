(function ($) {
  ...
  $(".team-active").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" class="slick-prev"><img src="img/bg/left-arrow.png"/></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="img/bg/right-arrow.png"/></button>',
    speed: 1000,
    slidesToShow: 3,
    slidesToScroll: 1,
    responsive: [
  ...
  $(".portfolio-active").slick({
    ...
    arrows: true,
    prevArrow:
      '<button type="button" class="slick-prev"><img src="img/bg/project-left.png"/></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="img/bg/project-right.png"/></button>',
    speed: 1000,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [
